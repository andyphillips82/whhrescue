...
function cmsms_register_theme_plugins() { 
	$plugins = array( 
		array( 
			...
			'source'				=> get_template_directory() . '/framework/admin/inc/plugins/cmsms-contact-form-builder.zip', 
			'required'				=> false, 
			'version'				=> '1.3.3', 
		...
		array( 
			...
			'source'				=> get_template_directory() . '/framework/admin/inc/plugins/cmsms-content-composer.zip', 
			'required'				=> true, 
			'version'				=> '1.5.7', 
		...
		array( 
			...
			'source'				=> get_template_directory() . '/framework/admin/inc/plugins/cmsms-mega-menu.zip', 
			'required'				=> true, 
			'version'				=> '1.2.4', 
			'force_activation'		=> false, 
			'force_deactivation' 	=> true 
		...
		array( 
			'name'					=> esc_html__('Envato Market', 'pet-rescue'), 
			'slug'					=> 'envato-market', 
		...
		array( 
			'name'					=> esc_html__('Cookie Notice', 'pet-rescue'), 
			'slug'					=> 'cookie-notice', 
			'required'				=> false 
		), 
		array( 
