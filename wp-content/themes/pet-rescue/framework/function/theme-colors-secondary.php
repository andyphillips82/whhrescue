...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.widget_shopping_cart_content .button:hover, 
	{$rule}.widget_shopping_cart_content .button.checkout, 
	...
	{$rule}.widget_shopping_cart_content .button, 
	{$rule}.widget_shopping_cart_content .button.checkout:hover {
	...
	{$rule}.cmsms_added_product_info:after {
		" . cmsms_color_css('border-' . (is_rtl() ? 'right' : 'left') . '-color', $cmsms_option[CMSMS_SHORTNAME . '_' . $scheme . '_bg_box']) . "
	}
...
/***************** Start {$title} Events Color Scheme Rules ******************/
	...
	{$rule}.widget.tribe-this-week-events-widget .tribe-this-week-event .entry-title a {
		" . cmsms_color_css('color', $cmsms_option[CMSMS_SHORTNAME . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.widget.tribe-this-week-events-widget .tribe-this-week-event .entry-title a:hover {
		" . cmsms_color_css('color', $cmsms_option[CMSMS_SHORTNAME . '_' . $scheme . '_heading']) . "
	}
	...
	{$rule}.widget.tribe_mini_calendar_widget .tribe-mini-calendar-wrapper .tribe-mini-calendar-grid-wrapper .tribe-mini-calendar .tribe-mini-calendar-nav div .tribe-mini-calendar-nav-link:hover span, 
	...
	{$rule}.widget.tribe_mini_calendar_widget .tribe-mini-calendar-wrapper .tribe-mini-calendar-grid-wrapper .tribe-mini-calendar .tribe-mini-calendar-nav div .tribe-mini-calendar-nav-link:hover span:before, 
	{$rule}.widget.tribe_mini_calendar_widget .tribe-mini-calendar-wrapper .tribe-mini-calendar-grid-wrapper .tribe-mini-calendar .tribe-mini-calendar-nav div .tribe-mini-calendar-nav-link:hover span:after {
		" . cmsms_color_css('border-color', $cmsms_option[CMSMS_SHORTNAME . '_' . $scheme . '_heading']) . "
	}
...
";
	...
	$cmsms_header_dropdown_bd = explode('|', $cmsms_option[CMSMS_SHORTNAME . '_header_dropdown_border']);
	...
	$cmsms_header_top_bg = explode('|', $cmsms_option[CMSMS_SHORTNAME . '_header_top_bg']);
...
/***************** Start Header Color Scheme Rules ******************/
	...
	.header_mid #navigation > li:after {
		" . cmsms_color_css('background-color', $cmsms_option[CMSMS_SHORTNAME . '_header_border']) . "
	}
	...
	.header_mid #navigation > li.menu-item-mega li li.current-menu-item > a[data-tag]:before, 
	.header_mid #navigation > li.menu-item-mega li li.current_page_item > a[data-tag]:before {
		" . cmsms_color_css('color', $cmsms_option[CMSMS_SHORTNAME . '_header_dropdown_hover_bg']) . "
	}
	...
	#header {
		-webkit-box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_bg[0]) . ", .2);
		-moz-box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_bg[0]) . ", .2);
		box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_bg[0]) . ", .2);
	}
	";
	...
	.header_mid #navigation ul,
	.header_mid #navigation > li.menu-item-mega > div.menu-item-mega-container {
		-webkit-box-shadow:3px 3px 3px 0 rgba(" . hex2rgb($cmsms_header_dropdown_bd[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_dropdown_shadow_opacity'] / 100) . ");
		-moz-box-shadow:3px 3px 3px 0 rgba(" . hex2rgb($cmsms_header_dropdown_bd[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_dropdown_shadow_opacity'] / 100) . ");
		box-shadow:3px 3px 3px 0 rgba(" . hex2rgb($cmsms_header_dropdown_bd[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_dropdown_shadow_opacity'] / 100) . ");
	}
	";
	}
...
/***************** Start Header Bottom Color Scheme Rules ******************/
	...
	.header_mid_outer .header_mid_inner #navigation > li.menu-item-has-children > a > span.nav_bg_clr:after {
		" . cmsms_color_css('border-bottom-color', $cmsms_option[CMSMS_SHORTNAME . '_header_bottom_dropdown_bg']) . "
	}
	...
	.header_bot #navigation > li.menu-item-mega li li.current-menu-item > a[data-tag]:before, 
	.header_bot #navigation > li.menu-item-mega li li.current_page_item > a[data-tag]:before {
		" . cmsms_color_css('color', $cmsms_option[CMSMS_SHORTNAME . '_header_bottom_dropdown_hover_bg']) . "
	}
	...
	#header {
		-webkit-box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_bottom_bg[0]) . ", .2);
		-moz-box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_bottom_bg[0]) . ", .2);
		box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_bottom_bg[0]) . ", .2);
	}
	";
	...
	.header_bot #navigation ul,
	.header_bot #navigation > li.menu-item-mega > div.menu-item-mega-container {
		-webkit-box-shadow:0 5px 15px 0 rgba(" . hex2rgb($cmsms_header_bottom_dropdown_bg[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_bottom_dropdown_shadow_opacity'] / 100) . ");
		-moz-box-shadow:0 5px 15px 0 rgba(" . hex2rgb($cmsms_header_bottom_dropdown_bg[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_bottom_dropdown_shadow_opacity'] / 100) . ");
		box-shadow:0 5px 15px 0 rgba(" . hex2rgb($cmsms_header_bottom_dropdown_bg[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_bottom_dropdown_shadow_opacity'] / 100) . ");
	}
	";
	}
...
/***************** Start Header Top Color Scheme Rules ******************/
	...
	.header_top_outer {
		-webkit-box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_top_bg[0]) . ", .2);
		-moz-box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_top_bg[0]) . ", .2);
		box-shadow:0 6px 2px -4px rgba(" . hex2rgb($cmsms_header_top_bg[0]) . ", .2);
	}
	";
	...
	$custom_css .= "
	.header_top_outer nav > div > ul > li ul {
		-webkit-box-shadow:0 0 2px 0 rgba(0, 0, 0, rgba(" . hex2rgb($cmsms_header_top_dropdown_bg[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_top_dropdown_shadow_opacity'] / 100) . ");
		-moz-box-shadow:0 0 2px 0 rgba(0, 0, 0, rgba(" . hex2rgb($cmsms_header_top_dropdown_bg[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_top_dropdown_shadow_opacity'] / 100) . ");
		box-shadow:0 0 2px 0 rgba(0, 0, 0, rgba(" . hex2rgb($cmsms_header_top_dropdown_bg[0]) . ', ' . ((int) $cmsms_option[CMSMS_SHORTNAME . '_header_top_dropdown_shadow_opacity'] / 100) . ");
	}
	";
	}
