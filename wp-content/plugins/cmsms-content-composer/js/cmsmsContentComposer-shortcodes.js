...
var cmsmsShortcodes = { 
	...
	cmsms_gallery : { 
		...
		fields : { 
			...
			gallery_type : { 
				type : 		'radio', 
				title : 	cmsms_shortcodes.gallery_field_gallery_type_title, 
				descr : 	"", 
				def : 		'grid', 
				required : 	true, 
				width : 	'half', 
				choises : { 
							'grid' : 		cmsms_shortcodes.gallery_field_gallery_type_grid, 
							'masonry' : 	cmsms_shortcodes.gallery_field_gallery_type_masonry 
				}, 
			...
			gallery_count : { 
				type : 		'input', 
				title : 	cmsms_shortcodes.gallery_field_gallery_count_title, 
				descr : 	cmsms_shortcodes.gallery_field_gallery_count_descr + "<br /><span>" + cmsms_shortcodes.note + ' ' + cmsms_shortcodes.gallery_field_gallery_count_descr_note + "</span>", 
				def : 		'', 
				required : 	false, 
				width : 	'number', 
				min : 		'1', 
			...
			gallery_padding : { 
				type : 		'input', 
				title : 	cmsms_shortcodes.gallery_field_gallery_padding_title, 
				descr : 	"<span>" + cmsms_shortcodes.note + ' ' + cmsms_shortcodes.gallery_field_gallery_padding_descr_note + "</span>", 
				def : 		'10', 
				required : 	false, 
				width : 	'number', 
				min : 		'0', 
