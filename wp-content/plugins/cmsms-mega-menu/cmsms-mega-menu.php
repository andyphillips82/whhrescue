...
class Cmsms_Mega_Menu { 
	function __construct() { 
		define('CMSMS_MEGA_MENU_VERSION', '1.2.4');
	...
	function cmsms_add_custom_admin_menu_header() {
		if (basename($_SERVER['PHP_SELF']) == 'nav-menus.php') {
			wp_register_style('cmsms-mega-menu', CMSMS_MEGA_MENU_URL . 'admin/css/mega-menu.css', array(), CMSMS_MEGA_MENU_VERSION, 'screen');
			
			wp_register_style('cmsms-mega-menu-rtl', CMSMS_MEGA_MENU_URL . 'admin/css/mega-menu-rtl.css', array(), CMSMS_MEGA_MENU_VERSION, 'screen');
			...
			if (is_rtl()) {
				wp_enqueue_style('cmsms-mega-menu-rtl');
			}
			
			
			wp_register_script('cmsms-mega-menu', CMSMS_MEGA_MENU_URL . 'admin/js/mega-menu.js', array('jquery', 'jquery-ui-sortable'), CMSMS_MEGA_MENU_VERSION, true);
	...
	function cmsms_add_custom_menu_header() {
		if (!is_admin()) {
			wp_register_script('megamenu', CMSMS_MEGA_MENU_URL . 'js/jquery.megaMenu.js', array('jquery'), CMSMS_MEGA_MENU_VERSION, true);
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="field-tag description description-thin">
					<label for="edit-menu-item-tag-<?php echo $item_id; ?>">
						<?php _e( 'Navigation Label Tag', 'cmsms_maga_menu' ); ?><br />
				...
				<p class="field-subtitle description description-thin">
					<label for="edit-menu-item-subtitle-<?php echo $item_id; ?>">
						<?php _e( 'Navigation Label Subtitle', 'cmsms_maga_menu' ); ?><br />
				...
				<p class="field-icon description description-thin">
					<label for="edit-menu-item-icon-<?php echo $item_id; ?>">
						<?php _e( 'Menu Item Icon', 'cmsms_maga_menu' ); ?><br />
						...
						<span id="edit-menu-item-icon-<?php echo $item_id; ?>_icon" data-class="cmsms_new_icon_img"<?php echo ((esc_attr($item->icon) != '') ? ' class="' . esc_attr($item->icon) . '" style="display:block;"' : ''); ?>></span>
						<input id="edit-menu-item-icon-<?php echo $item_id; ?>_button" class="cmsms_icon_choose_button button button-small" type="button" value="<?php _e( 'Choose icon', 'cmsms_maga_menu' ); ?>" />
						<a href="#" class="cmsms_remove_icon admin-icon-remove" title="<?php _e( 'Remove icon', 'cmsms_maga_menu' ); ?>"<?php echo ((esc_attr($item->icon) != '') ? ' style="display:inline-block;"' : ''); ?>></a>
					</label>
				</p>
				<p class="field-highlight description description-thin description-wafer-thin">
					<label for="edit-menu-item-highlight-<?php echo $item_id; ?>">
						...
						<?php _e( 'Highlight', 'cmsms_maga_menu' ); ?>
					</label>
				</p>
				<p class="field-hide_text description description-thin description-wafer-thin">
					<label for="edit-menu-item-hide_text-<?php echo $item_id; ?>">
						...
						<?php _e( 'Hide Text', 'cmsms_maga_menu' ); ?>
					</label>
				</p>
				...
				<p class="field-mega_bg_img description description-wide">
					...
					?>
					<label for="edit-menu-item-mega_bg_img-<?php echo $item_id; ?>" class="cmsms_upload_parent cmsms_select_parent">
						<?php _e( 'Mega Menu Background Image', 'cmsms_maga_menu' ); ?><br />
						<input type="button" id="cmsms_upload_<?php echo $item_id; ?>_button" class="cmsms_upload_button button button-small" value="<?php _e('Choose image', 'cmsms_maga_menu'); ?>" data-title="<?php _e('Choose image', 'cmsms_maga_menu'); ?>" data-button="<?php _e('Insert image', 'cmsms_maga_menu'); ?>" data-id="cmsms-media-select-frame-<?php echo $item_id; ?>" data-classes="media-frame cmsms-media-select-frame cmsms-frame-no-description cmsms-frame-no-caption cmsms-frame-no-align cmsms-frame-no-link" data-library="image" data-type="select" data-multiple="false" />
						<span class="cmsms_upload"<?php echo ($val_image != '') ? ' style="display:block;"' : ''; ?>>
							<img src="<?php echo $val_image; ?>" class="cmsms_preview_image" alt="" />
							<a href="#" class="cmsms_upload_cancel admin-icon-remove" title="<?php _e('Remove', 'cmsmasters'); ?>"></a>
						</span>
						<input id="edit-menu-item-mega_bg_img-<?php echo $item_id; ?>" name="menu-item-mega_bg_img[<?php echo $item_id; ?>]" type="hidden" class="cmsms_upload_image" value="<?php echo esc_attr( $item->mega_bg_img ); ?>" />
					</label>
				</p>
				<p class="field-mega_bg_pos description description-thin description-narrow">
					<label for="edit-menu-item-mega_bg_pos-<?php echo $item_id; ?>">
						<?php _e( 'Background Position', 'cmsms_maga_menu' ); ?><br />
						<select id="edit-menu-item-mega_bg_pos-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega_bg_pos" name="menu-item-mega_bg_pos[<?php echo $item_id; ?>]">
							<option value="top left"<?php selected( $item->mega_bg_pos, 'top left' ); ?>><?php _e( 'Top Left', 'cmsms_maga_menu' ); ?></option>
							<option value="top center"<?php selected( $item->mega_bg_pos, 'top center' ); ?>><?php _e( 'Top Center', 'cmsms_maga_menu' ); ?></option>
							<option value="top right"<?php selected( $item->mega_bg_pos, 'top right' ); ?>><?php _e( 'Top Right', 'cmsms_maga_menu' ); ?></option>
							<option value="center left"<?php selected( $item->mega_bg_pos, 'center left' ); ?>><?php _e( 'Center Left', 'cmsms_maga_menu' ); ?></option>
							<option value="center center"<?php selected( $item->mega_bg_pos, 'center center' ); ?>><?php _e( 'Center Center', 'cmsms_maga_menu' ); ?></option>
							<option value="center right"<?php selected( $item->mega_bg_pos, 'center right' ); ?>><?php _e( 'Center Right', 'cmsms_maga_menu' ); ?></option>
							<option value="bottom left"<?php selected( $item->mega_bg_pos, 'bottom left' ); ?>><?php _e( 'Bottom Left', 'cmsms_maga_menu' ); ?></option>
							<option value="bottom center"<?php selected( $item->mega_bg_pos, 'bottom center' ); ?>><?php _e( 'Bottom Center', 'cmsms_maga_menu' ); ?></option>
							<option value="bottom right"<?php selected( $item->mega_bg_pos, 'bottom right' ); ?>><?php _e( 'Bottom Right', 'cmsms_maga_menu' ); ?></option>
						</select>
					</label>
				</p>
				<p class="field-mega_bg_rep description description-thin description-narrow">
					<label for="edit-menu-item-mega_bg_rep-<?php echo $item_id; ?>">
						<?php _e( 'Background Repeat', 'cmsms_maga_menu' ); ?><br />
						<select id="edit-menu-item-mega_bg_rep-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega_bg_rep" name="menu-item-mega_bg_rep[<?php echo $item_id; ?>]">
							<option value="no-repeat"<?php selected( $item->mega_bg_rep, 'no-repeat' ); ?>><?php _e( 'No Repeat', 'cmsms_maga_menu' ); ?></option>
							<option value="repeat-x"<?php selected( $item->mega_bg_rep, 'repeat-x' ); ?>><?php _e( 'Repeat Horizontally', 'cmsms_maga_menu' ); ?></option>
							<option value="repeat-y"<?php selected( $item->mega_bg_rep, 'repeat-y' ); ?>><?php _e( 'Repeat Vertically', 'cmsms_maga_menu' ); ?></option>
							<option value="repeat"<?php selected( $item->mega_bg_rep, 'repeat' ); ?>><?php _e( 'Repeat', 'cmsms_maga_menu' ); ?></option>
						</select>
					</label>
				</p>
				<p class="field-mega_bg_size description description-thin description-narrow">
					<label for="edit-menu-item-mega_bg_size-<?php echo $item_id; ?>">
						<?php _e( 'Background Size', 'cmsms_maga_menu' ); ?><br />
						<select id="edit-menu-item-mega_bg_size-<?php echo $item_id; ?>" class="widefat edit-menu-item-mega_bg_size" name="menu-item-mega_bg_size[<?php echo $item_id; ?>]">
							<option value="auto"<?php selected( $item->mega_bg_size, 'auto' ); ?>><?php _e( 'Auto', 'cmsms_maga_menu' ); ?></option>
							<option value="cover"<?php selected( $item->mega_bg_size, 'cover' ); ?>><?php _e( 'Cover', 'cmsms_maga_menu' ); ?></option>
							<option value="contain"<?php selected( $item->mega_bg_size, 'contain' ); ?>><?php _e( 'Contain', 'cmsms_maga_menu' ); ?></option>
						</select>
					</label>
				</p>
...
class Walker_Cmsms_Nav_Mega_Menu extends Walker_Nav_Menu { 
	...
	function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) { 
		...
		if (function_exists('cmsms_custom_mega_menu_item_output')) {
			$nav_args = array( 
				'args' => 			$args, 
				'attrs' => 			$attributes, 
				'depth' => 			$depth, 
			...
			$item_output = apply_filters('cmsms_mega_item_output', $nav_args);
		}
